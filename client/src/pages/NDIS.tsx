...
import { ArrowRight, Heart, HelpingHand, Users, Activity, ClipboardCheck, CheckCircle, Info, FileText, Home } from "lucide-react";
...
const NDIS = () => {
  const [selectedService, setSelectedService] = useState(ndisServices[0]);
  ...
  useEffect(() => {
    const handleHashChange = () => {
      ...
      if (hash) {
        const matchingService = ndisServices.find(s => s.slug === hash);
        if (matchingService) {
  ...
  const handleServiceSelect = (service: typeof ndisServices[0]) => {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Explore our range of NDIS support services including daily living support, personal care, community participation, therapy services, and support coordination." />
        <meta property="og:title" content="NDIS Services | Vitality Community Care" />
        <meta property="og:description" content="Comprehensive NDIS support services tailored to your needs." />
      </Helmet>
      ...
      <section id="services-top" className="relative bg-gradient-to-br from-[hsl(var(--vitality-green))] to-[hsl(var(--vitality-blue-75))] text-white pt-20 pb-28 md:pb-32 lg:pb-36 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl font-semibold mb-4">NDIS Services</h1>
            <p className="text-xl mb-8 opacity-90">
              Vitality Community Care offers personalized therapeutic and support services under the NDIS,
      ...
      <section className="relative bg-white text-[hsl(var(--neutral-dark))] -mt-16 pt-28 md:pt-32 lg:pt-36 pb-20 md:pb-24 lg:pb-28 overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            <span className="text-[hsl(var(--vitality-blue))] font-medium uppercase tracking-wider">REGISTERED NDIS PROVIDER</span>
            <h2 className="text-3xl md:text-4xl font-bold mt-2 mb-6">How We Support NDIS Participants</h2>
            <p className="text-lg max-w-3xl mx-auto opacity-80">
              As a registered NDIS provider, we're committed to delivering high-quality, personalized services that align with your NDIS plan goals and aspirations.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-8 rounded-xl text-center relative shadow-md hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-medium mb-2">Plan Assessment</h3>
              <p>We thoroughly review your NDIS plan to understand your goals, budget, and support needs.</p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl text-center relative shadow-md hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-medium mb-2">Service Matching</h3>
              <p>We identify which of our services align with your goals and NDIS funding categories.</p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl text-center relative shadow-md hover:shadow-lg transition-shadow">
              ...
              <p>Our skilled staff deliver your selected services with a focus on your individual goals and preferences.</p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl text-center relative shadow-md hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-medium mb-2">Progress Monitoring</h3>
              <p>We regularly track your progress toward your goals and adjust services as needed to ensure optimal outcomes.</p>
            </div>
          </div>
        </div>
      ...
      <section id="service-list" className="py-16 bg-[hsl(var(--vitality-blue-10))]">
        <div className="container mx-auto px-4">
          ...
          <div ref={servicesListRef} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16 scroll-mt-32">
      ...
      <section className="py-16 bg-[hsl(var(--vitality-blue-5))]">
        <div className="container mx-auto px-4">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12 text-center max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-4">Ready to Get Started with NDIS Services?</h2>
            <p className="text-lg mb-8 max-w-2xl mx-auto">
              Contact us today to learn how our NDIS services can support your goals and enhance your quality of life.
            </p>
